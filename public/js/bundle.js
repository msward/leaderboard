...
var AddPrincessActions = function () {
  function AddPrincessActions() {
    _classCallCheck(this, AddPrincessActions);

    this.generateActions('addPrincessSuccess', 'addPrincessFail', 'updateName', 'updateBirthday', 'updateGender', 'invalidName', 'invalidBirthday', 'invalidGender');
  }

  _createClass(AddPrincessActions, [{
    key: 'addPrincess',
    value: function addPrincess(name, birthday, gender) {
      var _this = this;
      ...
      $.ajax({
        ...
        _this.actions.addPrincessSuccess(data.message);
      }).fail(function (jqXhr) {
        _this.actions.addPrincessFail(jqXhr.responseJSON.message);
      });
    }
  }]);

  return AddPrincessActions;
}();

exports.default = _alt2.default.createActions(AddPrincessActions);
...
var FooterActions = function () {
  function FooterActions() {
    ...
    this.generateActions('getTopPrincessesSuccess', 'getTopPrincessesFail');
  }

  _createClass(FooterActions, [{
    key: 'getTopPrincesses',
    value: function getTopPrincesses() {
      var _this = this;

      $.ajax({ url: '/api/princesses/top' }).done(function (data) {
        _this.actions.getTopPrincessesSuccess(data);
      }).fail(function (jqXhr) {
        _this.actions.getTopPrincessesFail(jqXhr);
      });
    }
  }]);
...
var NavbarActions = function () {
  function NavbarActions() {
    ...
    this.generateActions('updateOnlineUsers', 'updateAjaxAnimation', 'updateSearchQuery', 'getPrincessesCountSuccess', 'getPrincessesCountFail', 'findPrincessesSuccess', 'findPrincessesFail');
  }

  _createClass(NavbarActions, [{
    key: 'findPrincess',
    value: function findPrincess(payload) {
      var _this = this;
      ...
      $.ajax({
        ...
        _this.actions.findPrincessSuccess(payload);
      }).fail(function () {
        _this.actions.findPrincessFail(payload);
      });
    }
  }, {
    key: 'getPrincessCount',
    value: function getPrincessCount() {
      var _this2 = this;

      $.ajax({ url: '/api/princesses/count' }).done(function (data) {
        _this2.actions.getPrincessCountSuccess(data);
      }).fail(function (jqXhr) {
        _this2.actions.getPrincessCountFail(jqXhr);
      });
    }
  }]);
...
var _AddPrincessStore = require('../stores/AddPrincessStore');

var _AddPrincessStore2 = _interopRequireDefault(_AddPrincessStore);

var _AddPrincessActions = require('../actions/AddPrincessActions');

var _AddPrincessActions2 = _interopRequireDefault(_AddPrincessActions);
...
var AddPrincess = function (_React$Component) {
  _inherits(AddPrincess, _React$Component);

  function AddPrincess(props) {
    _classCallCheck(this, AddPrincess);

    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(AddPrincess).call(this, props));

    _this.state = _AddPrincessStore2.default.getState();
    _this.onChange = _this.onChange.bind(_this);
    return _this;
  }

  _createClass(AddPrincess, [{
    key: 'componentDidMount',
    value: function componentDidMount() {
      _AddPrincessStore2.default.listen(this.onChange);
    }
  }, {
    key: 'componentWillUnmount',
    value: function componentWillUnmount() {
      _AddPrincessStore2.default.unlisten(this.onChange);
    }
  }, {
    key: 'onChange',
    ...
    value: function handleSubmit(event) {
      ...
      if (!name) {
        _AddPrincessActions2.default.invalidName();
        this.refs.nameTextField.getDOMNode().focus();
      }

      if (!birthday) {
        _AddPrincessActions2.default.invalidBirthday();
        this.refs.birthdayTextField.getDOMNode().focus();
      }

      if (!gender) {
        _AddPrincessActions2.default.invalidGender();
      }

      if (name && birthday && gender) {
        _AddPrincessActions2.default.addPrincess(name, birthday, gender);
      }
    }
  }, {
    key: 'render',
                ...
                _react2.default.createElement(
                  ...
                  _react2.default.createElement(
                    ...
                    _react2.default.createElement('input', { type: 'text', className: 'form-control', ref: 'nameTextField', value: this.state.name,
                      onChange: _AddPrincessActions2.default.updateName, autoFocus: true }),
                    _react2.default.createElement(
                      'span',
                  ...
                  _react2.default.createElement(
                    'div',
                    { className: 'form-group ' + this.state.birthdayValidationState },
                    _react2.default.createElement(
                      'label',
                      { className: 'control-label' },
                      'Birthday'
                    ),
                    _react2.default.createElement('input', { type: 'text', className: 'form-control', ref: 'birthdayTextField', value: this.state.birthday,
                      onChange: _AddPrincessActions2.default.updateBirthday, autoFocus: true }),
                    _react2.default.createElement(
                      'span',
                      { className: 'help-block' },
                      this.state.helpBlock
                  ...
                  _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                      ...
                      _react2.default.createElement('input', { type: 'radio', name: 'gender', id: 'female', value: 'Female', checked: this.state.gender === 'Female',
                        onChange: _AddPrincessActions2.default.updateGender }),
                      _react2.default.createElement(
                        'label',
                        { htmlFor: 'female' },
                        'Female'
...
exports.default = AddPrincess;

},{"../actions/AddPrincessActions":1,"../stores/AddPrincessStore":12,"react":"react"}],6:[function(require,module,exports){
'use strict';
...
var Footer = function (_React$Component) {
  ...
  _createClass(Footer, [{
    ...
    value: function componentDidMount() {
      ...
      _FooterActions2.default.getTopPrincesses();
    }
  }, {
    key: 'componentWillUnmount',
    value: function componentWillUnmount() {
    ...
    key: 'render',
    value: function render() {
      var leaderboardPrincesses = this.state.princesses.map(function (princess) {
        return _react2.default.createElement(
          'li',
          { key: princess.princessId },
          _react2.default.createElement(
            _reactRouter.Link,
            { to: '/princesses/' + princess.princessId },
            _react2.default.createElement('img', { className: 'thumb-md', src: 'http://image.eveonline.com/Character/' + princess.princessId + '_128.jpg' })
          )
        );
      });
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                ...
                _react2.default.createElement(
                  'a',
                  { href: 'https://github.com/msward/leaderboard' },
                  'Source Code'
                ),
...
var _AddPrincess = require('./components/AddPrincess');

var _AddPrincess2 = _interopRequireDefault(_AddPrincess);
...
exports.default = _react2.default.createElement(
  ...
  _react2.default.createElement(_reactRouter.Route, { path: '/add', component: _AddPrincess2.default })
);

},{"./components/AddPrincess":5,"./components/App":6,"./components/Home":8,"react":"react","react-router":"react-router"}],12:[function(require,module,exports){
'use strict';
...
var AddPrincessStore = function () {
  function AddPrincessStore() {
    _classCallCheck(this, AddPrincessStore);

    this.bindActions(_AddPrincessActions2.default);
    this.name = '';
    this.birthday = '';
    this.gender = '';
    this.helpBlock = '';
  ...
  _createClass(AddPrincessStore, [{
    key: 'onAddPrincessSuccess',
    value: function onAddPrincessSuccess(successMessage) {
      this.nameValidationState = 'has-success';
      this.helpBlock = successMessage;
    }
  }, {
    key: 'onAddPrincessFail',
    value: function onAddPrincessFail(errorMessage) {
    ...
    key: 'onUpdateBirthday',
    value: function onUpdateBirthday(event) {
    ...
    key: 'onInvalidBirthday',
    value: function onInvalidBirthday() {
  ...
  return AddPrincessStore;
}();

exports.default = _alt2.default.createStore(AddPrincessStore);

},{"../actions/AddPrincessActions":1,"../alt":4}],13:[function(require,module,exports){
'use strict';
...
var FooterStore = function () {
  ...
  _createClass(FooterStore, [{
    key: 'onGetTopPrincessesSuccess',
    value: function onGetTopPrincessesSuccess(data) {
      this.princesses = data.slice(0, 5);
    }
  }, {
    key: 'onGetTopPrincessesFail',
    value: function onGetTopPrincessesFail(jqXhr) {
...
var NavbarStore = function () {
  ...
  _createClass(NavbarStore, [{
    key: 'onFindPrincessSuccess',
    value: function onFindPrincessSuccess(payload) {
      payload.history.pushState(null, '/princesses/' + payload.princessId);
    }
  }, {
    key: 'onFindPrincessFail',
    value: function onFindPrincessFail(payload) {
    ...
    key: 'onGetPrincessCountSuccess',
    value: function onGetPrincessCountSuccess(data) {
      this.totalPrincesses = data.count;
    }
  }, {
    key: 'onGetPrincessCountFail',
    value: function onGetPrincessCountFail(jqXhr) {
